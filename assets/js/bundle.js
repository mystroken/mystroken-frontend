...
(function (window, document) {
	...
	var TimelineLite = __webpack_require__(4);
	...
	var burgerToggler = document.getElementById('burger__toggler');
	var handleBurgerClick = function handleBurgerClick(event) {
	...
	var burger = Snap.select('#burger__svg');
	var burger_line_top = burger.select('#burger__line__top');
	var burger_line_middle = burger.select('#burger__line__middle');
	var burger_line_bottom = burger.select('#burger__line__bottom');
	var burger_line_inclined_left = burger.select('#burger__line__inclined__left');
	var burger_line_inclined_right = burger.select('#burger__line__inclined__right');
